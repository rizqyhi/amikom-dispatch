...
import me.rizqy.amikomdispatch.ViewBookmarkActivity;
...
public class BookmarkAdapter extends ArrayAdapter<BookmarkItem> {
    ...
    public BookmarkAdapter(Context context, ArrayList<BookmarkItem> news) {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        final BookmarkItem news = getItem(position);
        ViewHolder holder;
        ...
        holder.newsBody.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ViewBookmarkActivity.class);
